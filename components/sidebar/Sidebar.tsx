...
import { EditPanelSingle } from './EditPanelSingle';
import { EditPanelMulti } from './EditPanelMulti';
import { UnitCompositionList } from './UnitCompositionList';
            ...
            <div className="p-4 border-b border-grim-800 shrink-0">
                <div className="flex justify-between items-center mb-4">
                     <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-slate-500 font-mono tracking-normal opacity-60 pt-1">v{APP_VERSION}</span>
                     </div>
                 ...
                 {isBoardSettingsOpen && (
                     <div className="p-2 bg-grim-900/50 animate-in slide-in-from-top-2 duration-200 border-t border-grim-800 -mx-4 px-4 pt-4 mb-4 shadow-inner">
                         <BoardSettings 
                ...
                {/* Main Action Mode Switcher (Create vs Edit inferred) */}
                {selectedIds.length === 0 ? (
                    ...
                    <div className="bg-grim-800 p-2 rounded text-center border border-grim-700">
