  ...
  const activeLabelOverlays = useMemo(() => {
    ...
    groups.forEach((els, key) => {
        ...
        const text = els.length > 1
            ? `${first.groupLabel || first.label || "Unknown"} ×${els.length}`
            : (first.label || "Unknown");
